...
// const LINKEDIN_POST_URL_REGEX =
//   /https?:\/\/(?:www\.)?linkedin\.com\/(?:posts\/[^\s]+?(?:activity|ugcPost)-[A-Za-z0-9_-]+|feed\/update\/)/i;
 ...
 *
 * @example
 * const verifier = new LinkedInVerifier();
 * const result = await verifier.verifyKeywords({
 *   url: "https://www.linkedin.com/posts/withkynam_if-you-dont-grind-on-a-saturday-you-have-activity-7389678728915795969-SvPl",
